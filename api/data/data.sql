...
INSERT INTO publications (publication_date,pub_type,city,address,status,user_id) VALUES('2023-07-12','encontrados','Veracruz','C. Madre Selva 773, Dos Caminos, 91726 Veracruz, Ver.','OPEN',3);
INSERT INTO publications (publication_date,pub_type,city,address,status,user_id) VALUES('2023-12-04','perdidos','Buenos Aires','Av. Tte. Gral. Donato Álvarez 1351, C1416 CABA, Argentina','OPEN',5);
INSERT INTO publications (publication_date,pub_type,city,address,status,user_id) VALUES('2023-12-04','disponibles','Buenos Aires','Av. Gaona, C1416 CABA, Argentina','OPEN',6);
INSERT INTO publications (publication_date,pub_type,city,address,status,user_id) VALUES('2023-12-04','adoptados','Buenos Aires','Av. Gaona 1584, C1416 DRQ, Buenos Aires, Argentina','OPEN',7);
INSERT INTO publications (publication_date,pub_type,city,address,status,user_id) VALUES('2023-12-04','adoptados','Buenos Aires','Av. Gaona 1584, C1416 DRQ, Buenos Aires, Argentina','OPEN',7);
INSERT INTO pets (type,name,age,genre,size,breed,eye_color,description,fur,color,publication_id) VALUES('Gato','loli',2,'hembra','pequeña','Siames','azul','Nariz pinta miel y cafe','fino','bicolor',1);
INSERT INTO pets (type,name,age,genre,size,breed,eye_color,description,fur,color,publication_id) VALUES('Perro','Rufino',2,'macho','mediana','French','cafe','pelo corto','chino','blanco',2);
INSERT INTO pets (type,name,age,genre,size,breed,eye_color,description,fur,color,publication_id) VALUES('Perro','Doris',2,'hembra','grande','Pitbull','azul','color cafe con blanco y patas anchas','fino','bicolor',3);
INSERT INTO pets (type,name,age,genre,size,breed,eye_color,description,fur,color,publication_id) VALUES('Gato','Junior',2,'macho','chica','Angora','azul','ojos saltones','fino','blanco',4);
INSERT INTO pets (type,name,age,genre,size,breed,eye_color,description,fur,color,publication_id) VALUES('Perro','Firus',1,'macho','pequeña','pug','negro','muy nervioso','fino','bicolor',5);
...
INSERT INTO profile (name,phone,state,province,postal_code,user_id) VALUES ('Jimena Manrique','+54 11 1902 6478','Buenos Aires','Cucha cucha 1035','C1405AIK',7);
