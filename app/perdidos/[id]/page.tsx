        ...
        return (
            <div className="pageContainer">
                <div className="container">
                    <h1 className="text-3xl font-semibold text-gray-700 text-center py-6">
                        Perdidos
                    </h1>
                            ...
                            <div className="flex my-16">
                                <div className="w-[40%] pr-[5%]">
                                    <div className="py-4 flex flex-col justify-between items-start border-b-[1px] border-gray-200">
                                        <h1 className="text-4xl font-semibold text-gray-700 pb-4">
                                            { publication.pet_publication.name }
                                        </h1>
                                        <div className="wrap-atributes pb-4">
                                            <div className="atribute-lg">
                                                { publication.pet_publication.type === 'Perro' && (
                                                    <>
                                                        <Image className="w-[14px]" src={icon_dog} alt="dog" width={100} height={100} /> Perro
                                                    </>
                                                )}
                                                { publication.pet_publication.type === 'Gato' && (
                                                    <>
                                                        <Image className="w-[14px]" src={icon_cat} alt="cat" width={100} height={100} /> Gato
                                                    </>
                                                )}
                                            </div>
                                            <div className="atribute-lg">
                                                { publication.pet_publication.genre === 'macho' && (
                                                    <>
                                                        <BsGenderMale className="text-color3-500 text-sm" /> Macho
                                                    </>
                                                )}
                                                { publication.pet_publication.genre === 'hembra' && (
                                                    <>
                                                        <BsGenderFemale className="text-color3-500 text-sm" /> Hembra
                                                    </>
                                                )}
                                            </div>
                                        </div>
